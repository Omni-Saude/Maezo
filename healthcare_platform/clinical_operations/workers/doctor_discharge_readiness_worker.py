...
Business rules delegated to DMN: clinical_safety/doctor_discharge_readiness_scoring.
...
class DoctorDischargeReadinessWorker(BaseExternalTaskWorker):
    """
    Doctor Discharge Readiness Worker
    ...
    TOPIC = "clinical.doctor_discharge_readiness"
    DMN_DECISION_KEY = "doctor_discharge_readiness_scoring"
    DMN_CATEGORY = "clinical_safety"

    def execute(self, context: TaskContext) -> TaskResult:
        """
        Execute DoctorDischargeReadiness operation.
        ...
        try:
            ...
            self.logger.info(
                "Processing DoctorDischargeReadiness operation",
            ...
            self.logger.error(f"DoctorDischargeReadiness operation failed: {e}", exc_info=True)
