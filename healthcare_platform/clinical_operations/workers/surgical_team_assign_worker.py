...
Business rules delegated to DMN: clinical_safety/surgical_team_assign_assessment.
...
class SurgicalTeamAssignWorker(BaseExternalTaskWorker):
    ...
    TOPIC = "clinical.surgical_team_assign"
    DMN_DECISION_KEY = "surgical_team_assign_assessment"
    DMN_CATEGORY = "clinical_safety"

    def execute(self, context: TaskContext) -> TaskResult:
        """
        Execute SurgicalTeamAssign operation.
        ...
        try:
            ...
            self.logger.info(
                "Processing SurgicalTeamAssign operation",
            ...
            self.logger.error(f"SurgicalTeamAssign operation failed: {e}", exc_info=True)
