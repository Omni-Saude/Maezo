...
from healthcare_platform.shared.domain.exceptions import CodingException, MissingDiagnosisCode
from healthcare_platform.shared.domain.value_objects import CodedValue, FHIRReference
