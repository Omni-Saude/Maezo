...
from healthcare_platform.shared.integrations.tasy_client import TasyProcedureDTO
from healthcare_platform.shared.integrations.mv_soul_client import MvSoulBillingItemDTO
