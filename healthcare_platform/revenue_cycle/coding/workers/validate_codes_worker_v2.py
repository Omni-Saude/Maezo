...
class ValidateCodesWorkerV2(BaseExternalTaskWorker):
...
def register_worker(dmn_service: FederatedDMNService | None = None) -> ValidateCodesWorkerV2:
    """Create and return a configured ValidateCodesWorkerV2 instance."""
    return ValidateCodesWorkerV2(dmn_service=dmn_service)
