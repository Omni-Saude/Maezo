...
class SuggestTussWorkerV2(BaseExternalTaskWorker):
...
def register_worker(dmn_service: FederatedDMNService | None = None) -> SuggestTussWorkerV2:
    """Create and return a configured SuggestTussWorkerV2 instance."""
    return SuggestTussWorkerV2(dmn_service=dmn_service)
