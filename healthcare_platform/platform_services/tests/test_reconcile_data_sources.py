...
def worker(fhir_client):
    from healthcare_platform.platform_services.workers.reconcile_data_sources import ReconcileDataSourcesStub
    return ReconcileDataSourcesStub(fhir_client=fhir_client)

@pytest.mark.asyncio
async def test_happy_path_reconciles_data_sources(worker, tenant_hospital_a):
