...
class TestNotifyRegistrationCompleteWorker:
    @pytest.mark.asyncio
    async def test_happy_path_sends_notification(self, worker, fhir_client, tenant_hospital_a, mock_patient):
    ...
    @pytest.mark.asyncio
    async def test_notification_failure_logs_error(self, worker, fhir_client, tenant_hospital_a, mock_patient):
