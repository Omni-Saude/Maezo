...
class StubSchedulingSystemUpdater(SchedulingSystemUpdaterProtocol):
    ...
    def __init__(self):
        ...
        # DMN integration point: auth_timing_006
        # Inputs: {'appointment_id': appointment_id, 'status': status}
        # Call: self.dmn_service.evaluate(tenant_id=..., category='authorization', table_name='auth_timing_006', inputs={...})
