...
from platform.shared.domain.exceptions import AuthorizationDenied, AuthorizationExpired
from platform.shared.integrations.insurance_api_client import AuthorizationResponse
