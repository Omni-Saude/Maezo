"""Tests for SuggestCid10WorkerV2 (thin DMN-federated worker)."""
...
from healthcare_platform.revenue_cycle.coding.workers import SuggestCid10WorkerV2
...
def worker(mock_dmn_service):
    ...
    return SuggestCid10WorkerV2(dmn_service=mock_dmn_service)
