"""Tests for ValidateCodesWorkerV2 (thin DMN-federated worker)."""
...
from healthcare_platform.revenue_cycle.coding.workers import ValidateCodesWorkerV2
...
def worker(mock_dmn_service):
    ...
    return ValidateCodesWorkerV2(dmn_service=mock_dmn_service)
