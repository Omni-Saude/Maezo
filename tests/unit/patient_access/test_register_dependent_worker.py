...
from healthcare_platform.patient_access.workers.register_dependent_worker import (
    RegisterDependentWorker,
    DependentRegistrationInput,
    DependentRegistrationOutput,
    DependentRegistrarProtocol,
