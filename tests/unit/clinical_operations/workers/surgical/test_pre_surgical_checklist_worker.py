...
from healthcare_platform.clinical_operations.workers.surgical.pre_surgical_checklist_worker import PreSurgicalChecklistWorker
...
class PreSurgicalChecklistInput:
    """Stub for removed V1 Pydantic model."""
    def __init__(self, **kwargs): self.__dict__.update(kwargs)
class PreSurgicalChecklistOutput:
    """Stub for removed V1 Pydantic model."""
    def __init__(self, **kwargs): self.__dict__.update(kwargs)
