...
from healthcare_platform.clinical_operations.workers.surgical.surgical_materials_worker import SurgicalMaterialsWorker
...
class SurgicalMaterialsInput:
    """Stub for removed V1 Pydantic model."""
    def __init__(self, **kwargs): self.__dict__.update(kwargs)
class SurgicalMaterialsOutput:
    """Stub for removed V1 Pydantic model."""
    def __init__(self, **kwargs): self.__dict__.update(kwargs)
