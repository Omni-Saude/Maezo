...
from healthcare_platform.clinical_operations.workers.patient_recovery_checkin_worker import PatientRecoveryCheckinWorker
...
class PatientRecoveryCheckinInput:
