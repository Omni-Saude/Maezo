"""Shared fixtures for unit revenue cycle worker tests.

Provides tenant context setup for all revenue cycle unit tests.
"""
...
def setup_tenant_context():
    """Automatically set up tenant context for all revenue cycle unit tests.
