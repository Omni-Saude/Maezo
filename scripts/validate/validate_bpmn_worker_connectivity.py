...
Usage:
    python3 scripts/validate/validate_bpmn_worker_connectivity.py
    python3 scripts/validate/validate_bpmn_worker_connectivity.py --fix-topics
    python3 scripts/validate/validate_bpmn_worker_connectivity.py --json-report
