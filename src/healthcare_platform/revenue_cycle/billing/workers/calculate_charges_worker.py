...
class CalculateChargesWorker(BaseExternalTaskWorker):
    ...
    def execute(self, context: TaskContext) -> TaskResult:
        try:
            ...
            validatedQuantities = variables.get("validatedQuantities", [])
            modifiers = validatedQuantities
            ...
            if resultado == "BLOQUEAR":
                ...
                return TaskResult.success({"chargeBreakdown": line_items, "totalCharges": str(total_amt.amount), "modifier_adjustments": str(total_adj.amount)})
