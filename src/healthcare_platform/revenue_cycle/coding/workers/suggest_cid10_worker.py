...
class SuggestCid10Worker(BaseExternalTaskWorker):
...
def register_worker(dmn_service: FederatedDMNService | None = None) -> SuggestCid10Worker:
    """Create and return a configured SuggestCid10Worker instance."""
    return SuggestCid10Worker(dmn_service=dmn_service)
