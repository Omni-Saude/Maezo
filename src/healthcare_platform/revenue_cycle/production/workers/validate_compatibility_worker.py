...
class ValidateCompatibilityWorker(BaseExternalTaskWorker):
    ...
    def execute(self, context: TaskContext) -> TaskResult:
        ...
        try:
            ...
            # TODO: diagnoses sera usado na validacao de compatibilidade diagnostico-procedimento
            # diagnoses = variables.get("diagnoses", [])
            ...
            if resultado == "BLOQUEAR":
                return TaskResult.bpmn_error(
                    ...
                    variables={"risk": risco, "codes": codes, "incompatibleItems": codes},
                )
            ...
            needs_review = resultado == "REVISAR"
            return TaskResult.success({
                "compatible_procedures": procedures,
                "compatibility_warnings": warnings,
                "all_compatible": True,
                "compatibilityResult": "REVIEW_NEEDED" if needs_review else "COMPATIBLE",
                "incompatibleItems": [],
            })
