"""
Doctor_Readmission_Risk worker.
    
    Archetype: CLINICAL_SCORE

Refactored to V2 pattern using BaseExternalTaskWorker.
Business rules delegated to DMN: clinical_safety/doctor_readmission_risk_scoring.
...
class DoctorReadmissionRiskWorker(BaseExternalTaskWorker):
    """
    Doctor_Readmission_Risk worker.
    ...
    TOPIC = "clinical.doctor_readmission_risk"
    DMN_DECISION_KEY = "doctor_readmission_risk_scoring"
    DMN_CATEGORY = "clinical_safety"

    def execute(self, context: TaskContext) -> TaskResult:
        """
        Execute DoctorReadmissionRisk operation.
        ...
        try:
            ...
            self.logger.info(
                "Processing DoctorReadmissionRisk operation",
            ...
            self.logger.error(f"DoctorReadmissionRisk operation failed: {e}", exc_info=True)
