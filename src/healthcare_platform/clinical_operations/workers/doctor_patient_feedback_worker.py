...
Business rules delegated to DMN: clinical_safety/doctor_patient_feedback_scoring.
...
class DoctorPatientFeedbackWorker(BaseExternalTaskWorker):
    """
    Doctor Patient Feedback Worker
    ...
    TOPIC = "clinical.doctor_patient_feedback"
    DMN_DECISION_KEY = "doctor_patient_feedback_scoring"
    DMN_CATEGORY = "clinical_safety"

    def execute(self, context: TaskContext) -> TaskResult:
        """
        Execute DoctorPatientFeedback operation.
        ...
        try:
            ...
            self.logger.info(
                "Processing DoctorPatientFeedback operation",
            ...
            self.logger.error(f"DoctorPatientFeedback operation failed: {e}", exc_info=True)
