...
class StubTasyClient(TasyClientProtocol):
    ...
    def __init__(self):
        ...
        # DMN integration point: fed_auth_002
        # Inputs: {'patient_id': patient_id, 'patient_data': patient_data}
        # Call: self.dmn_service.evaluate(tenant_id=..., category='authorization', table_name='fed_auth_002', inputs={...})
