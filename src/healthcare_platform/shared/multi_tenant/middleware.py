"""FastAPI middleware for tenant extraction and context binding (ADR-002).

Extracts tenant_id from:
1. JWT token claims (Bearer token com claim tenant_id)
2. X-Tenant-ID header (serviços internos)
...
class TenantMiddleware(BaseHTTPMiddleware):
    ...
    ADR-002: tenant_id propagado para todos os serviços downstream.
    """
