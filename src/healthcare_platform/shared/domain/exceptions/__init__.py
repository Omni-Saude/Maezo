...
class RevenueCycleException(DomainException):
    ...
    bpmn_error_code: str = "REVENUE_CYCLE_ERROR"

    def __init__(self, message: str, details: dict[str, Any] | None = None, **kwargs: Any) -> None:
        super().__init__(message, bpmn_error_code="REVENUE_CYCLE_ERROR", details=details, **kwargs)
        self.code = "REVENUE_CYCLE_ERROR"
...
class PatientAccessException(DomainException):
    ...
    def __init__(self, message: str, details: dict[str, Any] | None = None, **kwargs: Any) -> None:
        super().__init__(message, bpmn_error_code="PATIENT_ACCESS_ERROR", details=details, **kwargs)
        self.code = "PATIENT_ACCESS_ERROR"
...
class ClinicalOperationsException(DomainException):
    ...
    def __init__(self, message: str, details: dict[str, Any] | None = None, **kwargs: Any) -> None:
        super().__init__(message, bpmn_error_code="CLINICAL_OPERATIONS_ERROR", details=details, **kwargs)
...
class SurgicalOperationsException(DomainException):
    ...
    bpmn_error_code: str = "SURGICAL_OPERATIONS_ERROR"

    def __init__(self, message: str, details: dict[str, Any] | None = None, **kwargs: Any) -> None:
        super().__init__(message, bpmn_error_code="SURGICAL_OPERATIONS_ERROR", details=details, **kwargs)
        self.code = "SURGICAL_OPERATIONS_ERROR"
