...
- Requires Keycloak service account for BPM engine access.
...
class BaseHandler(ABC):
    ...
    def _get_token(self) -> str:
        ...
        # Implementation uses client credentials flow
        # Cached with refresh before expiry
        ...
```
