...
**Enforcement:** `scripts/validate_bpmn_worker_connectivity.py` in CI/CD (exit code 1 on orphan BPMN topics).
...
- `scripts/validate_bpmn_worker_connectivity.py` — R7 enforcement

### Phase 2: Pre-commit Hooks (Week 2)
- `scripts/bpmn_pre_commit_hook.sh` — Local validation before push
...
- `scripts/validate_bpmn_worker_connectivity.py` — Connectivity validation script
