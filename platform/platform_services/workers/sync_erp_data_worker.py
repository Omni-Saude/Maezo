...
from platform.shared.integrations.tasy_client import TasyClientProtocol
from platform.shared.integrations.mv_soul_client import MVSoulClientProtocol
...
async def execute(input_data: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        from platform.shared.integrations.tasy_client import TasyClientStub
        from platform.shared.integrations.mv_soul_client import MVSoulClientStub
