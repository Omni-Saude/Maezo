...
from platform.shared.domain.exceptions import TISSException, TISSValidationError
from platform.shared.i18n import _
from platform.shared.integrations.tiss_client import TISSClientProtocol, TISSGuideDTO
